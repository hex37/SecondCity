/datum/action/cooldown/blood_power
	...
	background_icon = 'modular_darkpack/icons/ui/actions.dmi'
...
/datum/action/cooldown/blood_power/IsAvailable(feedback)
	...
	if (human_owner.bloodpool < cost)
		if (feedback)
			SEND_SOUND(human_owner, sound('modular_darkpack/sound/need_blood.ogg', 0, 0, 75))
...
/datum/action/cooldown/blood_power/Activate(mob/living/target)
	...
	playsound(usr, 'modular_darkpack/sound/bloodhealing.ogg', 50, FALSE)
