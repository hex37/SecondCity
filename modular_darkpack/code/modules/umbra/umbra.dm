...
/obj/minespot
	...
	icon = 'modular_darkpack/icons/umbra.dmi'
	icon_state = "tile1"
	plane = GAME_PLANE
...
/obj/umbra_portal/Bumped(atom/movable/AM)
	...
	if (istype(AM, /mob/living/carbon))
		...
		if (interacting_mob.client)
			...
			playsound(loc, 'modular_darkpack/sound/portal_enter.ogg', 75, FALSE)
			playsound(T, 'modular_darkpack/sound/portal_enter.ogg', 75, FALSE)
