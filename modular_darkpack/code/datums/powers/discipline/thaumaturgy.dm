...
/datum/discipline_power/thaumaturgy
	...
	activate_sound = 'modular_darkpack/sound/thaum.ogg'
	aggravating = TRUE
	hostile = TRUE
...
/obj/projectile/thaumaturgy
	...
	damage = 5
	damage_type = BURN
	hitsound = 'modular_darkpack/sound/drinkblood1.ogg'
...
/datum/discipline_power/thaumaturgy/theft_of_vitae
	...
	effect_sound = 'modular_darkpack/sound/vomit.ogg'
...
/datum/action/bloodshield/Trigger()
	...
	if(H.bloodpool < 2)
		...
		return
	H.bloodpool = max(H.bloodpool - 2, 0)
	playsound(H.loc, 'modular_darkpack/sound/thaum.ogg', 50, FALSE)
...
//	owner.color = "#ff0000"
	spawn(delay+owner.discipline_time_plus)
		if(owner)
			playsound(owner.loc, 'modular_darkpack/sound/thaum.ogg', 50, FALSE)
			owner.physiology.armor.melee = owner.physiology.armor.melee-(15*mod)
			owner.physiology.armor.bullet = owner.physiology.armor.bullet-(15*mod)
