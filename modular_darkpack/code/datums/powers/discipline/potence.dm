...
/datum/discipline_power/potence
	...
	activate_sound = 'modular_darkpack/sound/potence_activate.ogg'
	deactivate_sound = 'modular_darkpack/sound/potence_deactivate.ogg'
...
/datum/discipline_power/potence/one/activate()
	...
	owner.dna.species.attack_sound = 'modular_darkpack/sound/heavypunch.ogg'
