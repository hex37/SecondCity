...
/datum/discipline_power/dementation
	...
	activate_sound = 'modular_darkpack/sound/insanity.ogg'
...
/datum/discipline_power/dementation/passion/activate(mob/living/carbon/human/target)
	...
	var/mutable_appearance/dementation_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "dementation", -MUTATIONS_LAYER)
