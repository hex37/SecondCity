...
/obj/item/bong/attack(mob/hit_mob, mob/user, def_zone)
	...
	playsound(src, 'modular_darkpack/sound/heatdam.ogg', 50, TRUE)
	...
	if(moan_chance > 0)
		if(prob(moan_chance))
			playsound(hit_mob, pick('modular_darkpack/sound/lungbust_moan1.ogg','modular_darkpack/sound/lungbust_moan2.ogg', 'modular_darkpack/sound/lungbust_moan3.ogg'), 50, TRUE)
			hit_mob.emote("moan")
		else
			playsound(hit_mob, pick('modular_darkpack/sound/lungbust_cough1.ogg','modular_darkpack/sound/lungbust_cough2.ogg'), 50, TRUE)
			hit_mob.emote("cough")
	if(bong_hits <= 0)
