...
/datum/discipline_power/dominate
	...
	activate_sound = 'modular_darkpack/sound/dominate.ogg'
...
/datum/discipline_power/dominate/activate(mob/living/target)
	...
	if(ishuman(target))
		...
		var/mutable_appearance/dominate_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "dominate", -MUTATIONS_LAYER)
