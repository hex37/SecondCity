...
/mob/living/carbon/human/proc/set_body_weight(new_body_weight = AVERAGE_BODY_WEIGHT)
	...
	switch (new_body_weight)
		if (SLIM_BODY_WEIGHT)
			if (gender == FEMALE)
				AddComponent(/datum/component/clothes_weight_sprites, 'modular_darkpack/modules/depreciated/icons/worn_slim_f.dmi')
			else
				AddComponent(/datum/component/clothes_weight_sprites, 'modular_darkpack/modules/depreciated/icons/worn_slim_m.dmi')
		...
		if (FAT_BODY_WEIGHT)
			AddComponent(/datum/component/clothes_weight_sprites, 'modular_darkpack/modules/depreciated/icons/worn_fat.dmi')
