...
/datum/discipline_power/potence
	...
	activate_sound = 'sound/wod13/potence_activate.ogg'
	deactivate_sound = 'sound/wod13/potence_deactivate.ogg'
...
/datum/discipline_power/potence/one/activate()
	...
	owner.dna.species.attack_sound = 'sound/wod13/heavypunch.ogg'
