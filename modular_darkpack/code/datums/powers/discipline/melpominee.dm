...
/datum/discipline_power/melpominee
	...
	activate_sound = 'modular_darkpack/sound/melpominee.ogg'
...
/datum/discipline_power/melpominee/madrigal/activate()
	...
	for(var/mob/living/carbon/human/listener in oviewers(7, owner))
		...
		var/mutable_appearance/song_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "song", -MUTATIONS_LAYER)
...
/datum/discipline_power/melpominee/sirens_beckoning
	...
	effect_sound = 'modular_darkpack/sound/killscream.ogg'
