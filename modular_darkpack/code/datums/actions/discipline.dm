/datum/action/discipline
	check_flags = NONE
	background_icon = 'modular_darkpack/icons/ui/actions.dmi' //This is the file for the ACTION icon
	background_icon_state = "discipline" //And this is the state for the background icon
	button_icon = 'modular_darkpack/icons/ui/actions.dmi' //This is the file for the BACKGROUND icon
	button_icon_state = "discipline" //And this is the state for the action icon
	overlay_icon = 'modular_darkpack/icons/ui/actions.dmi'
...
/datum/action/discipline/proc/begin_targeting()
	...
	targeting = TRUE
	client.mouse_pointer_icon = 'modular_darkpack/icons/effects/mouse_pointers/discipline.dmi'
