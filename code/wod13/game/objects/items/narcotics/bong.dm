...
/obj/item/bong/attack(mob/hit_mob, mob/user, def_zone)
	...
	playsound(src, 'sound/wod13/heatdam.ogg', 50, TRUE)
	...
	if(moan_chance > 0)
		if(prob(moan_chance))
			playsound(hit_mob, pick('sound/wod13/lungbust_moan1.ogg','sound/wod13/lungbust_moan2.ogg', 'sound/wod13/lungbust_moan3.ogg'), 50, TRUE)
			hit_mob.emote("moan")
		else
			playsound(hit_mob, pick('sound/wod13/lungbust_cough1.ogg','sound/wod13/lungbust_cough2.ogg'), 50, TRUE)
			hit_mob.emote("cough")
	if(bong_hits <= 0)
