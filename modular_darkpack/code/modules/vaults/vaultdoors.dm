/obj/structure/vaultdoor
	...
	var/open_sound = 'modular_darkpack/sound/vault_door_opening.ogg'
	var/close_sound = 'modular_darkpack/sound/vault_door_closing.ogg'
	var/lock_sound = 'modular_darkpack/sound/vault_door_lock.ogg'
