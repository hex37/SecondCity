/area/vtm/financialdistrict
	...
	ambient_buzz = 'modular_darkpack/sound/ambience/downtown.ogg'
	upper = TRUE
...
/area/vtm/pacificheights
	...
	ambient_buzz = 'modular_darkpack/sound/ambience/hollywood.ogg'
	upper = TRUE
	wall_rating = HIGH_WALL_RATING
...
/area/vtm/chinatown
	...
	ambience_index = AMBIENCE_CITY
	ambient_buzz = 'modular_darkpack/sound/ambience/chinatown.ogg'
	upper = TRUE
...
/area/vtm/fishermanswharf
	...
	ambience_index = AMBIENCE_CITY
	ambient_buzz = 'modular_darkpack/sound/ambience/santamonica.ogg'
	upper = TRUE
	wall_rating = HIGH_WALL_RATING
...
/area/vtm/anarch
	...
	ambience_index = AMBIENCE_INTERIOR
	upper = FALSE
	ambient_buzz = 'modular_darkpack/sound/ambience/naive.ogg'
	zone_type = "elysium"
	fire_controled = TRUE
	wall_rating = HIGH_WALL_RATING
...
/area/vtm/church
	name = "Church"
	icon_state = "church"
	ambient_buzz = 'modular_darkpack/sound/ambience/hahihaho.ogg'
	ambience_index = AMBIENCE_INTERIOR
	upper = FALSE
	fire_controled = TRUE
...
/area/vtm/elevator
	name = "Elevator"
	icon_state = "prince"
	ambient_buzz = 'modular_darkpack/sound/ambience/lift.ogg'
	upper = FALSE
	zone_type = "elysium"
	fire_controled = TRUE
	wall_rating = HIGH_WALL_RATING
...
/area/vtm/forest
	...
	ambient_buzz = 'modular_darkpack/sound/ambience/night_ambience.ogg'
	yang_chi = 2
	yin_chi = 0
