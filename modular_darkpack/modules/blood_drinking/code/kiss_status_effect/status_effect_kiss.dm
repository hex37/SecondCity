...
/datum/status_effect/kissed/on_remove()
	to_chat(owner, "<span class='userdanger'>As you wake, you find it hard to recall anything of the past few minutes. All you remember is a pleasant, warm feeling. </span>") //feel free to change these
