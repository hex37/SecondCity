...
/obj/item/melee/vampirearms/eguitar
	...
	hitsound = 'modular_darkpack/sound/rock.ogg'
	sharpness = SHARP_EDGED
	max_integrity = 200
	armor = list(MELEE = 0, BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, RAD = 0, FIRE = 100, ACID = 30)
	resistance_flags = FIRE_PROOF
...
/obj/item/melee/vampirearms/eguitar/AltClick(mob/user)
	...
	if(result)
		...
		if(result == "1")
			playsound(loc, 'modular_darkpack/sound/solo1.ogg', 100, FALSE)
		if(result == "2")
			playsound(loc, 'modular_darkpack/sound/solo2.ogg', 100, FALSE)
		if(result == "3")
			playsound(loc, 'modular_darkpack/sound/solo3.ogg', 100, FALSE)
		if(result == "4")
			playsound(loc, 'modular_darkpack/sound/solo4.ogg', 100, FALSE)
