...
/datum/antagonist/hunter/on_gain()
	...
	owner.current.playsound_local(get_turf(owner.current), 'modular_darkpack/modules/deprecated/sounds/orthodox_start.ogg', 100, FALSE, pressure_affected = FALSE, use_reverb = FALSE)
	return ..()
