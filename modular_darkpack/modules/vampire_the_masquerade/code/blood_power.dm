...
/datum/action/cooldown/blood_power/Activate(mob/living/target)
	...
	human_owner.add_stat_mod(STAT_STRENGTH, 2, "blood_power")
	human_owner.add_stat_mod(STAT_DEXTERITY, 2, "blood_power")
	human_owner.add_stat_mod(STAT_STAMINA, 2, "blood_power")
...
/datum/action/cooldown/blood_power/proc/end_bloodpower()
	...
	human_owner.remove_stat_mod(STAT_STRENGTH, "blood_power")
	human_owner.remove_stat_mod(STAT_DEXTERITY, "blood_power")
	human_owner.remove_stat_mod(STAT_STAMINA, "blood_power")
