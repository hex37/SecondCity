/datum/outfit/job/sabbatist
	...
	backpack_contents = list(/obj/item/passport=1, /obj/item/vampire_stake=3, /obj/item/gun/ballistic/vampire/revolver=1, /obj/item/knife/vamp=1, /obj/item/vamp/keys/hack=1, /obj/item/scythe/vamp=1)
...
/datum/antagonist/sabbatist/on_gain()
	...
	owner.current.playsound_local(get_turf(owner.current), 'modular_darkpack/modules/deprecated/sounds/evil_start.ogg', 100, FALSE, pressure_affected = FALSE, use_reverb = FALSE)
	return ..()
