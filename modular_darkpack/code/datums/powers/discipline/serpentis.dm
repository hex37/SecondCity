...
/datum/discipline_power/serpentis
	...
	activate_sound = 'modular_darkpack/sound/serpentis.ogg'
...
/datum/discipline_power/serpentis/the_eyes_of_the_serpent/activate(mob/living/target)
	...
	if(target.dir == antidir)
		...
		if(ishuman(target))
			...
			var/mutable_appearance/serpentis_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "serpentis", -MUTATIONS_LAYER)
...
/datum/discipline_power/serpentis/the_tongue_of_the_asp
	...
	effect_sound = 'modular_darkpack/sound/tongue.ogg'
	aggravating = TRUE
	hostile = TRUE
	violates_masquerade = TRUE
