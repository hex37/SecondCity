		...
		switch(forecast[cityhour])
			...
			if("Rain")
				...
				for(var/obj/effect/vamp_weather/V in GLOB.rain_suka)
					...
					V.plane = GAME_PLANE
					V.icon = 'modular_darkpack/icons/newweather.dmi'
			...
			if("Fog")
				...
				for(var/obj/effect/vamp_weather/V in GLOB.rain_suka)
					...
					V.layer = SPACEVINE_LAYER
					V.plane = GAME_PLANE
					V.icon = 'modular_darkpack/icons/fog.dmi'
					V.icon_state = "fog"
					V.pixel_w = -96
					V.pixel_z = -96
...
/obj/effect/realistic_fog
	icon = 'modular_darkpack/icons/fog.dmi'
	icon_state = "fog"
	alpha = 0
	plane = GAME_PLANE
...
/obj/effect/new_rain
	icon = 'modular_darkpack/icons/newweather.dmi'
	icon_state = "rain1"
	alpha = 0
	plane = GAME_PLANE
	layer = SPACEVINE_LAYER
