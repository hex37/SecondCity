...
/datum/discipline_power/vicissitude
	...
	activate_sound = 'modular_darkpack/sound/vicissitude.ogg'
...
/datum/discipline_power/vicissitude/malleable_visage/proc/shapeshift(to_original = FALSE, instant = FALSE)
	...
	playsound(get_turf(owner), 'modular_darkpack/sound/vicissitude.ogg', 100, TRUE, -6)
...
/datum/discipline_power/vicissitude/fleshcrafting
	...
	effect_sound = 'modular_darkpack/sound/vicissitude.ogg'
	aggravating = TRUE
	hostile = TRUE
	violates_masquerade = TRUE
...
/datum/action/basic_vicissitude/proc/give_upgrade()
	...
	switch (upgrade)
		...
		if ("Centipede legs")
			...
			upgrade_overlay = mutable_appearance('modular_darkpack/icons/64x64.dmi', "centipede", -PROTEAN_LAYER)
		...
		if ("Second pair of arms")
			...
			user.remove_overlay(PROTEAN_LAYER)
			upgrade_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "2hands", -PROTEAN_LAYER)
	...
	playsound(get_turf(user), 'modular_darkpack/sound/vicissitude.ogg', 100, TRUE, -6)
