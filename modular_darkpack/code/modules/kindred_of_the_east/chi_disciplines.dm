/datum/action/chi_discipline
	...
	button_icon = 'modular_darkpack/icons/ui/kuei_jin.dmi' //This is the file for the BACKGROUND icon
	background_icon_state = "discipline" //And this is the state for the background icon

	icon_icon = 'modular_darkpack/icons/ui/kuei_jin.dmi' //This is the file for the ACTION icon
...
/datum/action/chi_discipline/ApplyIcon(atom/movable/screen/movable/action_button/current_button, force = FALSE)
	button_icon = 'modular_darkpack/icons/ui/kuei_jin.dmi'
	icon_icon = 'modular_darkpack/icons/ui/kuei_jin.dmi'
...
/datum/action/chi_discipline/proc/switch_level()
	SEND_SOUND(owner, sound('modular_darkpack/sound/highlight.ogg', 0, 0, 50))
	if(discipline)
...
/datum/chi_discipline
	...
	var/activate_sound = 'modular_darkpack/sound/chi_use.ogg'
...
/datum/chi_discipline/proc/check_activated(mob/living/target, mob/living/carbon/human/caster)
	...
	if(caster.yin_chi < cost_yin)
		SEND_SOUND(caster, sound('modular_darkpack/sound/need_blood.ogg', 0, 0, 75))
...
/datum/chi_discipline/blood_shintai
	...
	delay = 10 SECONDS
	cost_yin = 1
	activate_sound = 'modular_darkpack/sound/bloodshintai_activate.ogg'
...
/datum/chi_discipline/blood_shintai/activate(mob/living/target, mob/living/carbon/human/caster)
	...
	switch(level_casting)
		...
		if(2)
			playsound(get_turf(caster), 'modular_darkpack/sound/spit.ogg', 50, FALSE)
			spawn(1 SECONDS)
...
/datum/chi_discipline/jade_shintai
	...
	delay = 12 SECONDS
	cost_yang = 1
	activate_sound = 'modular_darkpack/sound/jadeshintai_activate.ogg'
...
/datum/chi_discipline/jade_shintai/activate(mob/living/target, mob/living/carbon/human/caster)
	...
	switch(level_casting)
		...
		if(5)
			...
			var/mutable_appearance/fortitude_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "[caster.base_body_mod]rock", -POTENCE_LAYER)
...
/datum/chi_discipline/bone_shintai
	...
	delay = 12 SECONDS
	cost_yin = 1
	activate_sound = 'modular_darkpack/sound/boneshintai_activate.ogg'
...
/datum/chi_discipline/ghost_flame_shintai
	...
	delay = 12 SECONDS
	cost_yang = 1
	activate_sound = 'modular_darkpack/sound/ghostflameshintai_activate.ogg'

/obj/item/gun/magic/ghostflame_shintai
	name = "fire spit"
	desc = "Spit fire on your targets."
	icon = 'modular_darkpack/icons/mobs.dmi'
	icon_state = "fireball"
	item_flags = NEEDS_PERMIT | ABSTRACT | DROPDEL | NOBLUDGEON
	flags_1 = NONE
	w_class = WEIGHT_CLASS_HUGE
...
/datum/chi_discipline/flesh_shintai
	...
	cost_yin = 1
	delay = 12 SECONDS
	activate_sound = 'modular_darkpack/sound/fleshshintai_activate.ogg'
...
/obj/item/gun/magic/hook/flesh_shintai
	...
	icon = 'modular_darkpack/icons/weapons.dmi'
	inhand_icon_state = "hook_hand"
	lefthand_file = 'modular_darkpack/icons/lefthand.dmi'
	righthand_file = 'modular_darkpack/icons/righthand.dmi'
	fire_sound = 'modular_darkpack/sound/vicissitude.ogg'
	max_charges = 1
...
/obj/projectile/flesh_shintai
	name = "hand"
	icon_state = "hand"
	icon = 'modular_darkpack/icons/icons.dmi'
...
/datum/chi_discipline/flesh_shintai/activate(mob/living/target, mob/living/carbon/human/caster)
	...
	switch(level_casting)
		...
		if(2)
			...
			var/mutable_appearance/potence_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "flesh_arms", -PROTEAN_LAYER)
			...
			caster.dna.species.attack_sound = 'modular_darkpack/sound/heavypunch.ogg'
...
/datum/chi_discipline/black_wind
	...
	ranged = FALSE
	activate_sound = 'modular_darkpack/sound/blackwind_activate.ogg'
	delay = 12 SECONDS
	cost_demon = 1
...
/datum/chi_discipline/black_wind/activate(mob/living/target, mob/living/carbon/human/caster)
	...
	switch(level_casting)
		if(1)
			...
			spawn((delay)+caster.discipline_time_plus)
				if(caster)
					caster.playsound_local(caster.loc, 'modular_darkpack/sound/blackwind_deactivate.ogg', 50, FALSE)
...
/datum/chi_discipline/demon_shintai
	...
	cost_demon = 1
	discipline_type = "Demon"
	activate_sound = 'modular_darkpack/sound/demonshintai_activate.ogg'
...
/datum/chi_discipline/demon_shintai/activate(mob/living/target, mob/living/carbon/human/caster)
	...
	switch(current_form)
		if("Samurai")
			...
			var/mutable_appearance/potence_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "samurai", -UNICORN_LAYER)
			...
			spawn((delay)+caster.discipline_time_plus)
				if(caster)
					...
					caster.remove_overlay(UNICORN_LAYER)
					REMOVE_TRAIT(caster, TRAIT_UNMASQUERADE, TRAUMA_TRAIT)
					caster.playsound_local(caster.loc, 'modular_darkpack/sound/demonshintai_deactivate.ogg', 50, FALSE)
		if("Tentacles")
			var/mod = level_casting
			caster.remove_overlay(UNICORN_LAYER)
			var/mutable_appearance/potence_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "tentacles", -UNICORN_LAYER)
			caster.overlays_standing[UNICORN_LAYER] = potence_overlay
			caster.apply_overlay(UNICORN_LAYER)
		...
		if("Demon")
			var/mod = level_casting
			caster.remove_overlay(UNICORN_LAYER)
			var/mutable_appearance/potence_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "demon", -UNICORN_LAYER)
			caster.overlays_standing[UNICORN_LAYER] = potence_overlay
			caster.apply_overlay(UNICORN_LAYER)
			ADD_TRAIT(caster, TRAIT_UNMASQUERADE, TRAUMA_TRAIT)
			switch(mod)
		...
		if("Giant")
			...
			caster.remove_overlay(UNICORN_LAYER)
			var/mutable_appearance/potence_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "giant", -UNICORN_LAYER)
			caster.overlays_standing[UNICORN_LAYER] = potence_overlay
			caster.apply_overlay(UNICORN_LAYER)
		...
		if("Foul")
			caster.remove_overlay(UNICORN_LAYER)
			var/mutable_appearance/potence_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "foul", -UNICORN_LAYER)
			caster.overlays_standing[UNICORN_LAYER] = potence_overlay
			caster.apply_overlay(UNICORN_LAYER)
			spawn()
...
/datum/chi_discipline/hellweaving
	...
	delay = 12 SECONDS
	cost_demon = 1
	activate_sound = 'modular_darkpack/sound/hellweaving_activate.ogg'
	discipline_type = "Demon"
...
/datum/chi_discipline/hellweaving/activate(mob/living/target, mob/living/carbon/human/caster)
	...
	switch(level_casting)
		...
		if(2)
			playsound(get_turf(target), 'modular_darkpack/sound/portal.ogg', 100, TRUE)
...
/datum/chi_discipline/iron_mountain
	...
	ranged = FALSE
	activate_sound = 'modular_darkpack/sound/ironmountain_activate.ogg'
	delay = 12 SECONDS
	cost_demon = 1
	discipline_type = "Demon"
...
//	var/mutable_appearance/fortitude_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "mountain", -FORTITUDE_LAYER)
...
//	caster.apply_overlay(FORTITUDE_LAYER)
	...
	spawn(delay+caster.discipline_time_plus)
		if(caster)
			caster.playsound_local(caster.loc, 'modular_darkpack/sound/ironmountain_deactivate.ogg', 50, FALSE)
			caster.physiology.armor.melee -= bonus
			caster.physiology.armor.bullet -= bonus
//			caster.remove_overlay(FORTITUDE_LAYER)
...
/datum/chi_discipline/kiai
	...
	delay = 12 SECONDS
	cost_demon = 1
	activate_sound = 'modular_darkpack/sound/kiai_activate.ogg'
	discipline_type = "Demon"
...
/datum/chi_discipline/kiai/activate(mob/living/target, mob/living/carbon/human/caster)
	..()
	var/sound_gender = 'modular_darkpack/sound/kiai_male.ogg'
	switch(caster.gender)
		if(MALE)
			sound_gender = 'modular_darkpack/sound/kiai_male.ogg'
		if(FEMALE)
			sound_gender = 'modular_darkpack/sound/kiai_female.ogg'
	caster.emote("scream")
...
/datum/chi_discipline/beast_shintai
	...
	delay = 12 SECONDS
	cost_yang = 1
	activate_sound = 'modular_darkpack/sound/beastshintai_activate.ogg'
...
/mob/living/simple_animal/hostile/crinos_beast
	...
	icon = 'modular_darkpack/icons/32x48.dmi'
...
/datum/chi_discipline/smoke_shintai
	...
	delay = 12 SECONDS
	cost_yang = 1
	activate_sound = 'modular_darkpack/sound/smokeshintai_activate.ogg'
	...
	switch(level_casting)
		...
		if(2)
			...
			if(length(available_turfs))
				...
				visual1.icon = 'modular_darkpack/icons/icons.dmi'
				...
				visual2.icon = 'modular_darkpack/icons/icons.dmi'
...
/datum/chi_discipline/storm_shintai
	...
	delay = 12 SECONDS
	cost_yang = 1
	activate_sound = 'modular_darkpack/sound/stormshintai_activate.ogg'

/obj/item/melee/touch_attack/storm_shintai
	name = "Storm touch"
	desc = "ELECTROCUTE YOURSELF!"
	catchphrase = null
	on_use_sound = 'modular_darkpack/sound/lightning.ogg'
	icon_state = "zapper"
...
/obj/item/gun/magic/hook/storm_shintai
	...
	lefthand_file = 'modular_darkpack/icons/lefthand.dmi'
	righthand_file = 'modular_darkpack/icons/righthand.dmi'
	fire_sound = 'modular_darkpack/sound/lightning.ogg'
	max_charges = 1
	item_flags = DROPDEL | NOBLUDGEON
	force = 18
...
/obj/projectile/storm_shintai
	...
	damage = 0
	stamina = 20
	hitsound = 'modular_darkpack/sound/lightning.ogg'
	var/chain
	var/knockdown_time = (0.5 SECONDS)
...
/obj/projectile/storm_shintai/on_hit(atom/target)
	...
	if(ismovable(target))
		...
		playsound(get_turf(target), 'modular_darkpack/sound/lightning.ogg', 100, FALSE)
		if (isliving(target))
...
/datum/chi_discipline/storm_shintai/activate(mob/living/target, mob/living/carbon/human/caster)
	...
	switch(level_casting)
		if(1)
			caster.remove_overlay(FORTITUDE_LAYER)
			var/mutable_appearance/fortitude_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "tornado", -FORTITUDE_LAYER)
		...
		if(5)
			caster.remove_overlay(FORTITUDE_LAYER)
			var/mutable_appearance/fortitude_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "puff_const", -FORTITUDE_LAYER)
			fortitude_overlay.alpha = 128
			caster.overlays_standing[FORTITUDE_LAYER] = fortitude_overlay
			caster.apply_overlay(FORTITUDE_LAYER)
			spawn()
...
/datum/chi_discipline/storm_shintai/proc/storm_aura_loop(mob/living/carbon/human/caster, duration)
	...
	while (world.time <= (loop_started_time + duration))
		for(var/mob/living/shocked_mob in oviewers(5, caster))
			...
			playsound(get_turf(shocked_mob), 'modular_darkpack/sound/lightning.ogg', 100, FALSE)
...
/datum/chi_discipline/equilibrium
	...
	cost_yin = 1
	discipline_type = "Chi"
	activate_sound = 'modular_darkpack/sound/equilibrium.ogg'
	...
	switch(level_casting)
		...
		if(4)
			for(var/mob/living/affected_mob in oviewers(5, caster))
				...
				playsound(get_turf(affected_mob), 'modular_darkpack/sound/vicissitude.ogg', 75, FALSE)
...
/datum/chi_discipline/feng_shui
	...
	cost_yin = 1
	discipline_type = "Chi"
	activate_sound = 'modular_darkpack/sound/feng_shui.ogg'
...
/datum/chi_discipline/feng_shui/activate(mob/living/target, mob/living/carbon/human/caster)
	...
	switch(level_casting)
		if(1)
			var/sound/auspexbeat = sound('modular_darkpack/sound/auspex.ogg', repeat = TRUE)
			...
			spawn(delay+caster.discipline_time_plus)
				if(caster)
					...
					caster.playsound_local(caster.loc, 'modular_darkpack/sound/auspex_deactivate.ogg', 50, FALSE)
		...
		if(3)
			if(caster.lastattacked)
				if(isliving(caster.lastattacked))
					...
					playsound(get_turf(cursing_mob), 'modular_darkpack/sound/hunger.ogg', 100, FALSE)
...
/datum/chi_discipline/tapestry
	...
	cost_yin = 1
	discipline_type = "Chi"
	activate_sound = 'modular_darkpack/sound/tapestry.ogg'
	//var/prev_z
	...
	switch(level_casting)
		...
		if(2)
			...
			if(do_mob(caster, caster, delay))
				...
				playsound(get_turf(caster), 'modular_darkpack/sound/portal.ogg', 100, TRUE)
			*/
		if(3)
...
/datum/chi_discipline/yin_prana
	...
	cost_yin = 2
	discipline_type = "Chi"
	activate_sound = 'modular_darkpack/sound/yin_prana.ogg'
...
/obj/item/melee/touch_attack/yin_touch/afterattack(atom/target, mob/living/carbon/user, proximity)
	...
	if(istype(target, /obj/structure/vampdoor))
		...
		if (door.lockpick_difficulty > 10)
			return ..()
		playsound(get_turf(target), 'modular_darkpack/sound/get_bent.ogg', 100, FALSE)
	...
	switch(level_casting)
		if(1)
			...
			spawn(delay+caster.discipline_time_plus)
				if(caster)
					if(caster.alpha != 255)
						caster.playsound_local(caster.loc, 'modular_darkpack/sound/obfuscate_deactivate.ogg', 50, FALSE)
						caster.alpha = 255
		if(2)
...
/datum/chi_discipline/yang_prana
	...
	cost_yang = 2
	discipline_type = "Chi"
	activate_sound = 'modular_darkpack/sound/yang_prana.ogg'
