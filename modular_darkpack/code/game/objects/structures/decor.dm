/obj/effect/decal/rugs
	name = "rugs"
	icon = 'modular_darkpack/icons/tiles.dmi'
	icon_state = "rugs"
...
/obj/structure/vampfence
	...
	icon = 'modular_darkpack/icons/props.dmi'
	icon_state = "fence"
	plane = GAME_PLANE
...
/obj/structure/lamppost
	...
	icon = 'modular_darkpack/icons/lamppost.dmi'
...
/obj/structure/foodrack
	name = "food rack"
	desc = "Have some food."
	icon = 'modular_darkpack/icons/64x64.dmi'
	icon_state = "rack2"
	plane = GAME_PLANE
	layer = ABOVE_ALL_MOB_LAYER
	anchored = TRUE
...
/obj/machinery/light/prince/ghost/Crossed(atom/movable/AM)
	...
	if(ishuman(AM))
		...
		if(L.client)
			...
			s.start()
			playsound(loc, 'modular_darkpack/sound/explode.ogg', 100, TRUE)
			qdel(src)
...
/obj/cargotrain
	...
	icon = 'modular_darkpack/icons/containers.dmi'
	icon_state = "1"
	plane = GAME_PLANE
	layer = CAR_LAYER
	anchored = TRUE
...
/obj/structure/marketplace
	...
	icon = 'modular_darkpack/icons/stonks.dmi'
...
/obj/structure/fuelstation/attackby(obj/item/I, mob/living/user, params)
	...
	if(istype(I, /obj/item/gas_can))
		...
		if(G.stored_gasoline < 1000 && stored_money)
			...
			playsound(loc, 'modular_darkpack/sound/gas_fill.ogg', 50, TRUE)
...
/obj/bacotell
	...
	icon = 'modular_darkpack/icons/fastfood.dmi'
	icon_state = "bacotell"
	plane = GAME_PLANE
	layer = CAR_LAYER
	anchored = TRUE
...
/obj/structure/strip_club
	...
	icon = 'modular_darkpack/icons/48x48.dmi'
	icon_state = "dora"
	plane = GAME_PLANE
	layer = ABOVE_ALL_MOB_LAYER
	anchored = TRUE
...
/obj/structure/fountain
	...
	icon = 'modular_darkpack/icons/fountain.dmi'
	icon_state = "fountain"
	plane = GAME_PLANE
	layer = CAR_LAYER
	anchored = TRUE
...
/obj/structure/coclock/grandpa
	icon = 'modular_darkpack/icons/grandpa_cock.dmi'
	icon_state = "cock"
	plane = GAME_PLANE
	layer = CAR_LAYER
	anchored = TRUE
...
/obj/structure/vamptree
	...
	icon = 'modular_darkpack/icons/trees.dmi'
	icon_state = "tree1"
	plane = GAME_PLANE
	layer = SPACEVINE_LAYER
	anchored = TRUE
...
/obj/structure/vamptree/pine
	name = "pine"
	desc = "Cute and tall flora."
	icon = 'modular_darkpack/icons/pines.dmi'
	icon_state = "pine1"
	plane = GAME_PLANE
	layer = SPACEVINE_LAYER
	anchored = TRUE
...
/obj/were_ice
	...
	icon = 'modular_darkpack/icons/werewolf_lupus.dmi'
	icon_state = "ice_man"
	plane = GAME_PLANE
	layer = CAR_LAYER
	resistance_flags = INDESTRUCTIBLE | LAVA_PROOF | FIRE_PROOF | UNACIDABLE | ACID_PROOF | FREEZE_PROOF
...
/obj/were_ice/crinos
	icon = 'modular_darkpack/icons/werewolf.dmi'
	icon_state = "ice"
	pixel_w = -8
