...
/datum/discipline_power/presence
	...
	activate_sound = 'modular_darkpack/sound/presence_activate.ogg'
	deactivate_sound = 'modular_darkpack/sound/presence_deactivate.ogg'
...
/datum/discipline_power/presence/awe/activate(mob/living/carbon/human/target)
	...
	var/mutable_appearance/presence_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "presence", -MUTATIONS_LAYER)
