...
/obj/structure/drill
	...
	var/drill_sound = 'modular_darkpack/sound/vault_drilling.ogg'
...
/obj/structure/drill/proc/update_effects()
	var/mutable_appearance/sparks = mutable_appearance('modular_darkpack/icons/particle_effects.dmi', "welding_sparks", ABOVE_ALL_MOB_LAYERS_LAYER, ABOVE_LIGHTING_PLANE)
	if(active)
		add_overlay(sparks)
	else
		cut_overlays()
