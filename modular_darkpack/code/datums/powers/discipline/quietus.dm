...
/datum/discipline_power/quietus
	...
	activate_sound = 'modular_darkpack/sound/quietus.ogg'
...
/obj/item/gun/magic/quietus/process_fire()
	...
	if(charges == 0)
		qdel(src)
/*
	playsound(target.loc, 'modular_darkpack/sound/quietus.ogg', 50, TRUE)
	...
	if(ishuman(target))
		...
		var/mutable_appearance/quietus_overlay = mutable_appearance('modular_darkpack/icons/icons.dmi', "quietus", -MUTATIONS_LAYER)
