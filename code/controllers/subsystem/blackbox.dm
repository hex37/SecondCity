...
/datum/controller/subsystem/blackbox/proc/ReportDeath(mob/living/L)
	...
	var/datum/db_query/query_report_death = SSdbcore.NewQuery({"
		...
		VALUES (:pod, :x_coord, :y_coord, :z_coord, :map, INET_ATON(:internet_address), :port, :round_id, NOW(), :job, :special, :name, :key, :laname, :lakey, :brute, :fire, :brain, :oxy, :tox, :aggravated, :stamina, :last_words, :suicide)
	"}, list( // DARKPACK EDIT CHANGE - AGGRAVATED_DAMAGE
		"name" = L.real_name,
		"key" = L.ckey,
